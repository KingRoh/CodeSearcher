package com.example.rohgun.a181117_test01;
...
import com.example.rohgun.a181117_test01.Adapter.ListTypeAdapter;
import com.example.rohgun.a181117_test01.Util.NaverShoppingSearchService;
import com.example.rohgun.a181117_test01.Util.SearchDataList;
import com.example.rohgun.a181117_test01.Util.CustomLayoutManager;
import com.example.rohgun.a181117_test01.Util.DBHelper;
import com.example.rohgun.a181117_test01.Util.Items;
import com.example.rohgun.a181117_test01.activity.MainActivity;
import com.example.rohgun.a181117_test01.activity.RecognizerActivity;
...
import static com.example.rohgun.a181117_test01.Util.DBHelper.DATABASE_VERSION;
import static com.example.rohgun.a181117_test01.Util.DBHelper.DATABASE_NAME;
...
public class SearchActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initView(){
        ...
        String data = intent.getStringExtra("result_text");
        query.setText(data);
       ...
       /* Call<SearchDataList> searchDataListCall = naverShoppingSearchService.getSearchList(queryString, displayValue, startValue, sortType);
        ...
        searchDataListCall.enqueue(new Callback<SearchDataList>() {
            ...
            public void onFailure(Call<SearchDataList> call, Throwable t) {
                Toast.makeText(SearchActivity.this, "에러가 발생했습니다. 다시 시도해주세요", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        if(pressedTime == 0){
            Toast.makeText(SearchActivity.this, "한 번 더 누르면 처음화면으로 이동합니다.", Toast.LENGTH_SHORT).show();
